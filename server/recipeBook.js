...
let recipeBook = [
{
    ...
    preparation: 'Preheat oven to 350°F. Coarsely chop atrtichoke hearts. Combine all ingredients in a medium bowl. Transfer mixture to 4-cup ovenproof soufflé dish or small casserole dish. Sprinkle some parmesan over the top for a thin crispy crust. Bake dip until heated through, about 30 minutes', 
...
}, 
{
    ...
    preparation: 'Mix ground beef, onion, green pepper, egg, ketchup, and sea salt together in a bowl; mix in the white bread pieces until evenly distributed. Form the mixture into 4 patties. Spray a large skillet with olive oil cooking spray and set over medium heat. Cook the burgers until well-browned on the bottoms, about 10 minutes; flip the burgers and cook until the meat is no longer pink and the juices run clear, 8 to 10 more minutes.', 
...
}, 
{
    ...
    desc: 'The longer it sits in the fridge, the better the taste seems to get.', 
    preparation: 'In a Dutch oven, cook beef over medium heat until no longer pink; drain and set aside. n the same pot, heat oil; saute onions until tender. Add garlic; cook 1 minute longer. Stir in the green pepper, salt, chili powder, bouillon, cayenne, cinnamon, cumin and oregano. Cook for 2 minutes, stirring until combined. Add tomatoes and browned beef. Stir in water. Bring to a boil. Reduce heat; cover and simmer for about 1 hour. Add beans and heat through. If desired top with sour cream and jalapeno.', 
...
}, 
{
    ...
    preparation: 'Using a large glass or biscuit cutter, cut bread into rounds and discard crust. Spread peanut butter to the edges of each bread round. Repeat with jelly, then sprinkle with strawberries, blueberries, and graham crackers. Drizzle with honey, fold like a taco, and serve.', 
    image: './images/image09.jpg', 
    category: 'Mexican', 
    ingredients: ['4 slices white bread', '1/3 cup peanut butter', '1/3 cup jelly', '1/2 cup chopped strawberries', '1/2 cup blueberries', '1/4 c. crushed graham crackers', 'Honey, for drizzling']
}, 
{
    id: 10, 
    title: 'Donut Apples', 
